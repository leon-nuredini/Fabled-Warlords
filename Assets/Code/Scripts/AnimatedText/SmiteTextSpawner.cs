...
public class SmiteTextSpawner : SceneSingleton<SmiteTextSpawner>
{
    ...
    public void SpawnTextGameObject(LUnit lUnit, Vector3 spawnPosition)
    {
        ...
        _statusEffectSpawner.QueueStatusTextEffect(lUnit, _text, spawnPosition, _textSpawnDelay, _textOutlineColors.SmiteColor);
    }
}
